...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-SKRMAA5;Database=POS;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<BranchOffice>(entity =>
        {
            entity.HasKey(e => e.BranchOfficeId).HasName("PK__BranchOf__27247FF98C884A01");
        ...
        {
            entity.HasKey(e => e.BusinessId).HasName("PK__Business__F1EAA36E13A6B692");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Categori__19093A0B67442B1E");
        ...
        {
            entity.HasKey(e => e.ClientId).HasName("PK__Clients__E67E1A24C03D94C2");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED98160AF5");
        ...
        {
            entity.HasKey(e => e.DistrictId).HasName("PK__District__85FDA4C62C9EE926");
        ...
        {
            entity.HasKey(e => e.DocumentTypeId).HasName("PK__Document__DBA390E15F3AF28B");
        ...
        {
            entity.HasKey(e => e.MenuId).HasName("PK__Menus__C99ED230DF162BF8");
        ...
        {
            entity.HasKey(e => e.MenuRolId).HasName("PK__MenuRole__6640AD0CBE2BC5A8");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6CD9577FC8B");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687DA696CA26");
        ...
        {
            entity.HasKey(e => e.ProvinceId).HasName("PK__Province__FD0A6F83F1B62DAA");
        ...
        {
            entity.HasKey(e => e.PurcharseId).HasName("PK__Purchars__A98C674B7EC2E254");
        ...
        {
            entity.HasKey(e => e.PurcharseDetailId).HasName("PK__Purchars__7353248BCDB9C3F2");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE1A1368549C");
        ...
        {
            entity.HasKey(e => e.SaleId).HasName("PK__Sales__1EE3C3FFA777223A");
        ...
        {
            entity.HasKey(e => e.SaleDetailId).HasName("PK__SaleDeta__70DB14FE7DFFFD90");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4C8FDFEC21");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A359E14A08B");
        ...
        {
            entity.HasKey(e => e.UserBranchOfficeId).HasName("PK__UsersBra__7D1E804A545CC8AC");
